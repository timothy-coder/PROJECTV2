import {
  ...
  CalendarDays, CalendarRange, TableProperties, Store
} from "lucide-react";
export const HOME_ITEM = {
  to: "/home",
  label: "Panel de Control",
  icon: Home,
  perms: [["home", "ventasview"], ["home", "ventasviewall"], ["home", "posventaview"], ["home", "posventaviewall"]],
};
...
export const NAV_TREE = [
  {
    ...
    items: [
      ...
      { to: "/proveedores", label: "Proveedores", icon: Package, perm: ["proveedores", "view"] },
  ...
  },
  {
    ...
    items: [
      { to: "/puntoventa", label: "Punto de Venta", icon: Store, perm: ["puntoventa", "view"] },
      { to: "/puntoventa/cotizacion", label: "Cotizacion", icon: Receipt, perms: [["puntoventa_cotizaciones", "view"], ["puntoventa_cotizaciones", "viewteam"], ["puntoventa_cotizaciones", "viewall"], ["puntoventa", "view"]] },
      { to: "/puntoventa/anticipos", label: "Anticipos", icon: Coins, perms: [["puntoventa_anticipos", "view"], ["puntoventa_anticipos", "viewteam"], ["puntoventa_anticipos", "viewall"], ["puntoventa", "view"]] },
    ],
  },
  {
    key: "ppventa",
    ...
    items: [
      ...
      { to: "/ubicacion-inventario", label: "Ubicacion inventario", icon: Boxes, perm: ["ubicacion_inventario", "view"] },
  ...
  },
  {
    ...
    label: "PosVenta",
    items: [
      { to: "/panelpostventa", label: "Panel de PosVenta", icon: Calendar, perms: [["oportunidadespv", "view"], ["oportunidadespv", "viewall"], ["leadspv", "view"], ["leadspv", "viewall"]] },
      { to: "/proximosmantenimientos", label: "Proximos mantenimientos", icon: CalendarCheck, perms: [["proximosmantenimientos", "view"], ["proximosmantenimientos", "viewall"]] },
      { to: "/ordenes", label: "Ordenes", icon: ClipboardList, perms: [["ordenespv", "view"], ["ordenespv", "viewall"]] },
      { to: "/planeador-taller", label: "Planeador de Taller", icon: CalendarRange, perms: [["planeador_tallerpv", "view"], ["planeador_tallerpv", "viewall"]] },
      { to: "/citas", label: "Agenda", icon: Calendar, perms: [["citas", "view"], ["citas", "viewall"], ["oportunidadespv", "view"], ["oportunidadespv", "viewall"], ["leadspv", "view"], ["leadspv", "viewall"]] },
      { to: "/citas/nueva", label: "Nueva Cita", icon: CalendarCheck, perm: ["citas_nueva", "view"] },
      { to: "/citaspv", label: "Citas", icon: CalendarCheck, perms: [["citas", "view"], ["citas", "viewall"]] },
      { to: "/recepcion", label: "Recepción", icon: CalendarCheck, perm: ["recepcion", "view"] },
      { to: "/oportunidadespv", label: "Oportunidades", icon: Calendar, perms: [["oportunidadespv", "view"], ["oportunidadespv", "viewall"]] },
      { to: "/leadspv", label: "Leads", icon: Calendar, perms: [["leadspv", "view"], ["leadspv", "viewall"]] },
  ...
  },
  {
    ...
    label: "Ventas",
    items: [
      { to: "/paneloportunidad", label: "Panel de Ventas ", icon: Calendar, perms: [["agenda", "view"], ["agenda", "viewall"]] },
      { to: "/agenda", label: "Agenda", icon: Calendar, perms: [["agenda", "view"], ["agenda", "viewall"], ["oportunidades", "view"], ["oportunidades", "viewall"], ["leads", "view"], ["leads", "viewall"]] },
      { to: "/oportunidades", label: "Oportunidades", icon: CalendarDays, perms: [["oportunidades", "view"], ["oportunidades", "viewall"]] },
      { to: "/leads", label: "Leads", icon: CalendarRange, perms: [["leads", "view"], ["leads", "viewall"]]},
      { to: "/leads-ford", label: "Leads Ford", icon: CalendarRange, perm: ["leads_ford", "view"] },
      { to: "/reservas", label: "Notas de Pedido", icon: Calendar, perm: ["reservas", "view"] },
    ],
  },
  {
    key: "mensajes",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/configagenda", label: "Configuración de Ventas", icon: Settings, perms: [["configagenda", "view"], ["configuracion_horas", "view"], ["configuracion_usuario_counts", "view"]] },
      ...
      { to: "/configuracion-anaqueles", label: "Config. Anaqueles", icon: Boxes, perm: ["config_anaqueles", "view"] },
      { to: "/external-api", label: "API Externa", icon: SlidersHorizontal, perm: ["external_api", "view"] },

...
export const NAV_TREE = [
  ...
  },
  {
    ...
    label: "PostVenta",
    items: [
      { to: "/panelpostventa", label: "Panel de PostVenta", icon: Calendar, perm: ["oportunidadespv", "view"] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/configpostventa", label: "Configuración de PostVenta", icon: Settings, perm: ["configcotizacion", "view"] },

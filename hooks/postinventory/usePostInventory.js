...
export function usePostInventory() {
  const [data, setData] = useState({
    ...
    options: {
      ...
      currencies: [],
      allCurrencies: [],
      defaultPostventaCurrencyId: null,
      activeTax: null,
      centers: [],
      workshops: [],
      counters: [],
  ...
  const reload = useCallback(async () => {
    ...
    setData({
      ...
      options: {
        ...
        voucherTypes: next.options?.voucherTypes || [],
        currencies: next.options?.currencies || [],
        allCurrencies: next.options?.allCurrencies || [],
        defaultPostventaCurrencyId: next.options?.defaultPostventaCurrencyId || null,
        activeTax: next.options?.activeTax || null,

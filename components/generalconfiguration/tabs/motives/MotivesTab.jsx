          ...
          <div className="overflow-hidden rounded-lg border border-slate-200 border-l-4 border-l-blue-500 bg-white">
            <div className="flex flex-col gap-3 bg-blue-50 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-4">
              ...
              <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center">
                ...
                {canCreateMotivo ? (
                  <Button onClick={openCreateMotivo} className="w-full bg-blue-600 text-white hover:bg-blue-700 sm:w-auto">
                      ...
                      <div className="flex min-h-14 items-center justify-between gap-3 px-3 py-2.5">
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          {canCreateSubmotivo && canViewSubmotivos ? (
                            <Button variant="outline" size="sm" onClick={() => openCreateSubmotivo(motivo)}>
                              <Plus className="size-4" />
                              Sub
                            </Button>
                          ) : null}

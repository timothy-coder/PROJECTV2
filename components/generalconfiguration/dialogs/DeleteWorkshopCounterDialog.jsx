...
export function DeleteWorkshopCounterDialog({ open, type, item, onClose, onConfirm }) {
  if (!open) return null;

  return (
    <DeleteWorkshopCounterDialogContent
...
function DeleteWorkshopCounterDialogContent({ type, item, onClose, onConfirm }) {
  const [deleting, setDeleting] = useState(false);
  const [error, setError] = useState("");
  const label = typeLabel[type] || "registro";

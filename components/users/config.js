export const USER_PERMISSION_GROUPS = [
  ...
  { key: "clientes", label: "Clientes", actions: ["view", "viewall", "create", "edit", "delete", "vehicles"] },
  ...
  { key: "inventariocarros", label: "Precios de Carros", actions: ["view", "create", "edit", "delete", "import", "export", "history", "history_create", "pending_purchase"] },

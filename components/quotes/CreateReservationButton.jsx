...
export function CreateReservationButton({ opportunityId, quoteId }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="inline-flex h-9 items-center gap-2 rounded-md bg-blue-600 px-3 text-sm font-bold text-white shadow-sm hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
    >

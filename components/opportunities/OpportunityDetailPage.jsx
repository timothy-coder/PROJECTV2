        ...
        {items.map((t) => {
          ...
          <div key={t.id} className="relative flex items-start justify-between gap-3 rounded-lg border p-3">
            ...
            <div className="hidden flex-wrap justify-end gap-2 sm:flex">
              ...
              <Button size="sm" variant="outline" className="h-8 text-xs" onClick={() => setCertificate({ item: t, startedAt: t.inicioPruebaAt ? new Date(t.inicioPruebaAt) : new Date() })}><FileText className="size-4" />Certificado</Button>
              ...
              <Button size="sm" variant="outline" className="h-8 border-blue-300 text-xs text-blue-700" onClick={() => setSurvey(t)}><MessageSquare className="size-4" />Encuesta</Button>
            ...
            <div className="sm:hidden">
              ...
              {openMenu === t.id ? (
                <div className="absolute right-3 top-12 z-30 w-44 rounded-lg border border-slate-200 bg-white p-1 text-sm shadow-xl">
                  ...
                  <button type="button" className="block w-full rounded-md px-3 py-2 text-left font-medium hover:bg-slate-100" onClick={() => runMobile(() => setCertificate({ item: t, startedAt: t.inicioPruebaAt ? new Date(t.inicioPruebaAt) : new Date() }))}>Certificado</button>
                  ...
                  <button type="button" className="block w-full rounded-md px-3 py-2 text-left font-medium text-blue-700 hover:bg-blue-50" onClick={() => runMobile(() => setSurvey(t))}>Encuesta</button>
